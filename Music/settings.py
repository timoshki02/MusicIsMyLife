...
SECRET_KEY = 'e4oggdfl2%oxo24*fld^j2#%7#h9wzb3^z956yyt_&l)ywoapc'
...
if os.getenv('SERVER_SOFTWARE', '').startswith('Google App Engine'):
    ...
    DATABASES = {
        'default': {
            ...
            'HOST': '/cloudsql/music-165216:us-central1:music',
            'NAME': 'Music',
            'USER': 'music',
            'PASSWORD': 'Rattata23',
        }
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'mimlife2',                      # Or path to database file if using sqlite3.
